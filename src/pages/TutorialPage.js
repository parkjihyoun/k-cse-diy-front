...
const TutorialPage = () => {
  ...
  <div className={styles.RulesContainer}>
    ...
    <div className={styles.Rules}>
      <ol>
        <li>메인 페이지의 '지금 예약하기'를 클릭해주세요.<br/>(또는 상단 오른쪽의 예약 버튼 클릭)</li>
        <li>달력에서 빈 시간과 날짜 확인 후 날짜 선택, 예약하기 버튼 클릭</li>
        <li>이름과 학번, 예약 시간, 예약 사유를 작성합니다.</li>
        <li>초기 비밀번호 설정 후 예약하기 클릭,<br/>비밀번호는 예약 확인, 취소 시 필요하니 꼭 기억해 주세요.</li>
        <li>예약 대기 표시가 예약 완료로 변경되면 예약 확정입니다.</li>
      </ol>
    </div>
  </div>
  ...
  <div className={styles.EditContainer}>
    ...
    <ol>
              <li>상단 오른쪽의 예약 확인/수정 버튼을 클릭해주세요.</li>
              <li>이름과 학번 입력 후 예약 정보를 확인합니다.</li>
              <li>이름과 학번, 예약 시간, 예약 사유를 작성합니다.</li>
              <li>초기 비밀번호 설정 후 예약하기 클릭,<br/>비밀번호는 예약 확인, 취소 시 필요하니 꼭 기억해 주세요.</li>
              <li>예약 대기 표시가 예약 완료로 변경되면 예약 확정입니다.</li>
            </ol>
